  ...
  return (
    <section className="w-full bg-white" aria-labelledby="about-heading">
      <div className="flex w-full flex-col items-center px-4 py-16 text-center">
        <Breadcrumb className="mb-6 hidden xl:block xl:w-[1280px] xl:pl-20">
        ...
        <div className="flex w-full max-w-3xl flex-col items-center sm:w-[600px]">
          <span className="mb-4 inline-block w-40 rounded-full bg-[#CBE0E4] px-3 py-1 text-sm font-medium">
            À propos
          </span>
          ...
          <p className="m-auto mb-6 w-[100%] text-gray-600">
            ...
            Businesses of every size—from new startups to public companies—use our software to manage their businesses.
          </p>
          <Link
            href="/About#Carrer"
