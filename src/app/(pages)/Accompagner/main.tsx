...
const MainForm = () => {
  return (
    <div className="container mx-auto mt-0 lg:px-0">
      {/* Breadcrumb */}
      <div className="flex flex-col items-center justify-between lg:flex-row">
        <div>
          <Breadcrumb>
            <BreadcrumbList className="mb-6 mt-0 flex flex-row items-center space-x-2 lg:ml-24">
              <BreadcrumbItem>
                <BreadcrumbLink href="/">
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink className="text-gray-600" href="/Accompagner">
                  Accompagnement
                </BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
        ...
        <div className="mt-10">
          <Image alt="" className="object-cover" height={550} src="/Homepage/newAcc.svg" width={550} />
        </div>
      </div>
