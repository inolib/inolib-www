...
const Main = () => {
  return (
    <div className="container mx-auto xs:ml-0 lg:px-0">
      {/* Breadcrumb */}
      <div className="flex flex-col items-center justify-between lg:flex-row">
        <div>
          <Breadcrumb>
            <BreadcrumbList className="mb-6 mt-16 flex items-center space-x-2 xs:ml-6 md:ml-10 lg:ml-24">
              <BreadcrumbItem>
                <BreadcrumbLink href="/">
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink className="text-gray-600" href="/Audit">
                  Audit
                </BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          ...
          <div className="xs:ml-6 lg:ml-24">
            <h1 className="text-4xl font-bold text-gray-900">Audit d’accessibilité numérique</h1>
          </div>
        </div>

        <div className="mr-10 mt-10 w-1/3">
          <Image alt="" className="object-cover" height={450} src="/Homepage/med1.svg" width={650} />
        </div>
      </div>

      <div className="mt-6 px-4 pb-4 xs:ml-6 lg:ml-14 lg:mt-12 lg:flex lg:space-x-16 lg:px-10">
        ...
        <div className="mb-16 mt-10 space-y-6 xs:mr-7 lg:mt-0 lg:w-1/2">
