    ...
    <div className="container mx-auto mt-0 lg:px-0">
      ...
      <div className="flex flex-col items-center justify-between lg:flex-row">
        <div>
          <Breadcrumb>
            <BreadcrumbList className="mb-6 ml-24 mt-0 flex items-center space-x-2">
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink className="text-gray-600" href="/former">
                  Formations
                </BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
        ...
        <div className="mr-10 mt-10">
          <Image alt="" className="object-cover" height={450} src="/Homepage/newFor.svg" width={450} />
        </div>
      </div>
      ...
      <div className="ml-14 mt-6 px-4 pb-4 lg:mt-12 lg:flex lg:space-x-16 lg:px-10">
        ...
        <div className="mb-14 mt-10 space-y-6 lg:mt-0 lg:w-1/2">
