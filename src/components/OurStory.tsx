...
const OurStory: React.FC = () => {
  return (
    <section className="container py-16 px-4 lg:px-0  xs:min-w-full xxs:min-w-full bg-[#FAFAFA]">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-4 md:mx-10 my-10">
