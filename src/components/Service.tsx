    ...
    <section className="bg-[#FCFBF9] py-20" aria-labelledby="services-heading">
      <div className="container px-4">
        <div className="mb-12 text-center">
          ...
          <h2 id="services-heading" className="mb-4 mt-4 text-3xl lg:font-semibold xxs:font-semibold md:text-4xl xxs:w-[320px] lg:w-auto xxs:mx-auto xxs:text-3xl md:w-256">
        ...
        <div className="space-y-12 xxs:flex-col xxs:ml-1">
          <div className="flex flex-col items-center py-6 xxs:py-2 xs:py-3 md:flex-row">
            <div>
              <div className="lg:mx-10 max-w-128 xxs:mr-12  flex-col">
                <Image src="/Icons/fichier.svg" alt="" width={40} height={40}></Image>

                <h3 className="mb-2 mt-2 pt-2 text-2xl font-semibold xxs:w-92 ">Audits d'accessibilité numérique</h3>
            ...
            <div className="mb-6 ml-24 flex-shrink-0 md:mb-0 md:mr-6 xxs:mt-8 ">
              <Image src="/Homepage/image1.svg" alt="" width={550} height={550} className=""/>
            </div>
          </div>

          <div className="flex flex-col items-center justify-center md:flex-row">
            <div className="mb-6 flex-shrink-0 md:mb-0 md:mr-6 lg:mr-60 order-1 md:order-none">
          ...
          <div className="flex flex-col items-center py-6 md:flex-row">
            <div className="lg:w-128 flex-col px-10 xxs:mr-14 xxs:w-80">
            ...
            <div className="mb-6 xxs:ml-32 lg:ml-20 flex-shrink-0 md:mb-0 md:mr-6 xxs:mt-8 order-1 md:oeder-none ">
              <Image src="/Homepage/macon.svg" alt="" width={400} height={400} />
            </div>
          </div>

          <div className="flex flex-col items-center md:flex-row">
            <div className="mb-6 flex-shrink-0 md:mb-0 md:mr-6 lg:mr-60 order-1 md:order-none xxs:mt-8">
            ...
            <div className="mr-12 max-w-128 flex-col">
              ...
              <ul className="mb-4 list-disc pl-1">
                <li className="Items-start flex py-1">
                  <Image src="/Icons/CheckIcon.svg" alt="" width={20} height={20} className="mr-2" />
