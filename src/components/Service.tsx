    ...
    <section className="bg-[#FCFBF9] py-20" aria-labelledby="services-heading">
      <div className="flex flex-col items-center px-4">
        <div className="mb-12 text-center">
          ...
          <h2
            id="services-heading"
            className="mb-4 mt-4 text-center text-3xl xxs:mx-auto xxs:text-3xl sm:w-[720px] md:text-4xl"
          >
        ...
        <div className="mx-4 flex w-full flex-col items-center justify-center space-y-12">{servicesToDiplay}</div>
      </div>
    </section>
  );
};
