...
function MyMenuComponent() {
  ...
  return (
    <>
      <button {...buttonProps} ref={ref} aria-label="Menu">☰</button>
      {state.isOpen && (
        <OverlayContainer>
          <Popover state={state}>
            <Menu onAction={(key) => console.log(key)}>
              ...
              <Item key="audit"><Link href='/pages/audit'>Auditer</Link></Item>
              <Item key="accompagner"><Link href='/pages/accompagner'>Accompagner</Link></Item>
              <Item key="developpement"><Link href='/pages/developpement'>Developper</Link></Item>
              <Item key="former"><Link href='/pages/former'>Formations</Link></Item>
              <Item key="apropos"><Link href='/pages/ABout'>A propos</Link></Item>
              <Item key="blog"><Link href='/blog'>Blog</Link></Item>
              <Item key="contact"><Link href='/pages/contact'><Button variant='buttonNoir'>Nous contacter</Button></Link></Item>
            </Menu>
          </Popover>
        </OverlayContainer>
      )}
