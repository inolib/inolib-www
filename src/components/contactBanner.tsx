...
const ContactBanner = () => {
  return (
    <section className="py-8 px-4 bg-white" aria-labelledby="contact-heading">
      <div className="max-w-5xl mx-auto bg-gray-100 rounded-lg shadow-md overflow-hidden md:flex">
        ...
        <div className="md:w-2/3 p-8 flex flex-col justify-center items-center text-center">
          ...
          <Button  variant='buttonNoir' aria-label="Nous contacter" > <Link href='/pages/contact'>Nous contacter </Link></Button>
        </div>
        <div className="md:w-1/3 p-4">
          <Image
